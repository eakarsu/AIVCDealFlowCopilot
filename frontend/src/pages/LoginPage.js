...
export default function LoginPage() {
  ...
  const [email, setEmail] = useState('admin@vcdeal.io');
  ...
  return (
    <div className="login-shell">
      <form className="login-card" onSubmit={handleSubmit}>
        <h1 className="login-brand">VC DEAL FLOW</h1>
        <p className="login-sub">Pipeline · IC · LP Reporting</p>
        ...
        <p className="login-hint">
          Demo: <code>admin@vcdeal.io</code> / <code>admin123</code>
        </p>
      </form>
    </div>
  );
